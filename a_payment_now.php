...
$(function(){
  // 상품 총액 계산
    ...
    var orderprice = comma(orderprice);
...
// });
   ...
   <hr style="margin-top:-2px;" class="cart_titlebottom_line" width="50%" align="center" border="5px">
     ...
     ?>
     <form name="form" id="form" method="post" action="a_payment_completed.php">
         ...
         <div class="cartitem">
          ...
          <div class="price">
            <b><input style="border:none; background-color:white;" type="text" value="<?php echo number_format($price*$num);?>" class="sum" name="sum" size="6" readonly>원</b>
          </div>

          <input style="margin-top:23px; float:right; margin-right:70px; border:none; background-color:white; display:inline-block;" class="count" type="text" name="amount" value="<?php echo $num;?>" size="3">

            <hr class="cart_cart_line" width="100%" border="5px">
            <input type="hidden" id="data" name="idx" value="<?php echo $idx;?>">
      ...
      <hr class="cart_price_line" width="100%" align="center" border="5px">
        ...
        <b><input style="border:none; background-color:white; margin-right:-10px;" type="text" value="<?php echo number_format($price*$num);?>" class="total" name="total" size="6" readonly></b>
      ...
      <div class="memberInfo">
        ...
        <label>주문자 정보</label><br />
        <hr />
        이름 &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; <?php echo $user_name;?><br />
        연락처 &nbsp;:&nbsp; <?php echo $user_phone;?><br />
        주소 &nbsp;&nbsp;&nbsp;&nbsp;:&nbsp; <?php echo $user_roadaddress;?> <?php echo $user_detailaddress;?>
        <hr />
      </div>
        </div>
      ...
      <div class="shippingInfo">
        <div class="form-group">
            <label>배송지 선택</label>
                    <input type="radio" id="radio" name="radio1" checked> 회원 정보와 동일
                    <input type="radio" id="radio" name="radio2"> 새로운 배송지
        </div>
        ...
        <script>
          ...
          $("input[name=radio1]").click(function(){
            ...
            $("#name").val("<?php echo $user_name;?>");
            $("#phoneNumber").val("<?php echo $user_phone;?>");
            $("#postCode").val("<?php echo $user_postcode;?>");
            $("#roadAddress").val("<?php echo $user_roadaddress;?>");
            $("#detailAddress").val("<?php echo $user_detailaddress;?>");
             ...
             if (rsp.success) {
               ...
               $.post("a_order_ok.php",
               {
                 ...
                 idx : data
                           ...
                           objs.setAttribute('name','ordernum');
                           objs.setAttribute('value','<?php echo $ordernum;?>');
                           form.appendChild(objs);
                           form.setAttribute('method','post');
                           form.setAttribute('action',"a_payment_completed.php");
