...
<html lang="en" dir="ltr">
  ...
  <body>
    			...
    			<form name="form" id="form" role="form" method="post" action="write_ok.php" enctype="multipart/form-data">
            <div class="container" role="main">

              <div class="write_title">
                <p style=""><h3>상품등록</h3></p>
              </div>

          <div class="mb-3">
            <label for="title" style="margin-top:50px;">카테고리</label>
            <div id="in_area">
                <select name="category" style="height:35px;">
                  ...
                  <option value="천연파우더">천연파우더</option>
    				...
    				<div class="mb-3">
    					...
    					<input type="text" class="form-control" name="sub_title" id="reg_id">
            ...
            <div class="mb-3">
    					...
    					<input type="text" class="form-control" name="price" id="reg_id">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" name="jeago" id="reg_id">
