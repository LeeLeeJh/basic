...
<div class="menutitle">
  <p class="menu_title" style="text-decoration:underline;">케이크·쿠키</p>
</div>
...
<!-- <td width="500"><a href="read.php?id=<php echo $board["id"];?>"><php echo $title;?></a></td> -->
    ...
    <div class="cardwrapper">
      ...
      $sql = mysqli_query($conn, "select * from feedboard where category='케이크·쿠키';");
      ...
      <a href="a_product_inner.php?idx=<?php echo $idx;?>"><div class="card">
        ...
        <!-- <b><input style="font-size:17px; border:none; background-color:white;"class="price" id="price" type="text" value="<?php echo number_format($price);?>" readonly></b><p style="display:inline-block; margin-left:-160px; font-size:17px;"><b>원</b></p> -->
      </div></a>
